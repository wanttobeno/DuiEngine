...
// void OnDuiScroll(UINT uSbCode,int nPos,DuiEngine::CDuiScrollBar *pBar)
...
//treectrl
#define DUINM_TREECTRL_VITEM_EXPAND 41
typedef struct tagDUINMTREECTRLITEMEXPAND
{
	DUINMHDR hdr;
	HSTREEITEM item;
}DUINMTREECTRLITEMEXPAND, *LPDUINMTREECTRLITEMEXPAND;
