...
protected:
	...
	void OnBtnWebkitGo();
	void OnBtnWebkitBack();
	void OnBtnWebkitFore();
	...
	DUI_NOTIFY_MAP_BEGIN()
		...
		DUI_NOTIFY_NAME_COMMAND("btn_webkit_back",OnBtnWebkitBack)
		DUI_NOTIFY_NAME_COMMAND("btn_webkit_fore",OnBtnWebkitFore)
	DUI_NOTIFY_MAP_END()	
private:
	CMainDlg * m_pMainDlg; 
};
