...
{
	m_strSrcFile=CSoUIHelper::GetEditText(FindChildByName2<CDuiRichEdit*>("edit_src_file"));
	m_strResPath=CSoUIHelper::GetEditText(FindChildByName2<CDuiRichEdit*>("edit_res_path"));
	m_strResName=CSoUIHelper::GetEditText(FindChildByName2<CDuiRichEdit*>("edit_res_name"));
	m_strResType=CSoUIHelper::GetComboboxText(FindChildByName2<CDuiComboBox*>("cbx_res_type"));
