...
//////////////////////////////////////////////////////////////////////////
//  CDxDatePickerButton
CDxDatePickerButton::CDxDatePickerButton()
{
...
CString CDxDatePickerButton::GetCaption() const
{
    return m_strCaption;
}

void CDxDatePickerButton::SetCaption(LPCTSTR pcszCaption)
{
...
//////////////////////////////////////////////////////////////////////////
//  CDxDatePickerDay
CDxDatePickerDay::CDxDatePickerDay(CDxMonthPicker* pControl, CDxDatePickerMonth* pMonth, COleDateTime dtDay)
...
CDxDatePickerDay::~CDxDatePickerDay()
{
}
...
BOOL CDxDatePickerDay::IsToday(COleDateTime &dt) const
{
    BOOL bReturn = FALSE;
...
CDxDatePickerMonth::~CDxDatePickerMonth()
{
    ClearDays();
}
...
void CDxDatePickerMonth::AdjustLayout(CRect rcClient)
{
    AutoAdjustLayout(rcClient);
}

CDxDatePickerDay* CDxDatePickerMonth::GetDay(int nIndex) const
{
...
int CDxDatePickerMonth::GetDayCount() const
{
    return (int)m_arrDays.GetCount();
}

void CDxDatePickerMonth::Triangle(CDCHandle dc, CPoint pt0, CPoint pt1, CPoint pt2, COLORREF clrColor)
{
    //CPen pen;
...
void CDxDatePickerMonth::OnLButtonUp(UINT /*nFlags*/, CPoint /*point*/)
{
}
...
int CDxMonthPicker::OnCreate(LPVOID)
{
...
void CDxMonthPicker::AddButton()
{
    m_btnToday = new CDxDatePickerButton();

    m_btnToday->m_nID = XTP_IDS_DATEPICKER_TODAY;
    m_btnToday->m_strCaption = _T("Today");
}

void CDxMonthPicker::AdjustLayout(CRect rcClient)
{
    m_dtToday = COleDateTime::GetCurrentTime();
...
void CDxMonthPicker::CreateMonth()
{
    CString s = m_dtFirstMonth.Format();
    COleDateTime dtNextMonth(m_dtFirstMonth);

    m_monthPicker = new CDxDatePickerMonth(this, dtNextMonth);
...
CSize CDxMonthPicker::CalcButtonSize() const
{
    // get button size
...
void CDxMonthPicker::SetButtonRect()
{
    CSize szButton(CalcButtonSize());
...
void CDxMonthPicker::CalcButtonBandRect()
{
    SetButtonRect();
}
...
void CDxMonthPicker::Select(const COleDateTime& dtDay)
{
    m_dtFSelBase = dtDay;
...
void CDxMonthPicker::EnsureVisible(const COleDateTime& dtDate)
{
...
int GetEqualLeftSymbols(const CString& str1, const CString& str2)
{
...
BOOL CDxMonthPicker::GetCurSel(COleDateTime& refDateTime) const
{
    refDateTime = m_dtFSelBase;
    return TRUE;
}

BOOL CDxMonthPicker::SetCurSel(const COleDateTime& refDateTime)
{
...
void CDxMonthPicker::SetToday(const COleDateTime& refDateTime)
{
    m_dtToday = refDateTime;
    NotifyInvalidate();
}

BOOL CDxMonthPicker::ShiftDate(COleDateTime &refDate, int nMonthCount)
{
