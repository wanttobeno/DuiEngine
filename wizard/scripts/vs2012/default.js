...
function AddFilesToCustomProj(proj, strProjectName, strProjectPath, InfFile)
{
	try
	{
		...
		if(isSupportNamedID)
		{//支持namedid
			cmdline= '"$(DUIENGINEPATH)\\tool\\residbuilder2.exe" -i "%(FullPath)" -y -p skin -r .\\duires\\winres.rc2 -n .\\duires\\name2id.xml -h .\\duires\\winres.h';
			outfiles=".\\duires\\winres.rc2;.\\duires\\winres.h;.\\duires\\name2id.xml";
		}else
		{
			cmdline= '"$(DUIENGINEPATH)\\tool\\residbuilder2.exe" -i "%(FullPath)" -y -p skin -r .\\duires\\winres.rc2';
